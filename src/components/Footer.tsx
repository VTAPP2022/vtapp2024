...
import vitLogoWhite from "@vtapp/assets/vitap-logo-white.png";
    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <Image src={vitLogoWhite} alt="vitap logo" className="max-w-xs" />
          </a>
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              href="https://goo.gl/maps/AGmVY72C5zEhfYVa8"
              target="_blank"
        ...
        <div>
          <span className="text-base font-bold tracking-wide white">
            Social
          </span>
          <div className="flex items-center mt-1 space-x-3">
            ...
            <a
              href="https://www.instagram.com/vtapp.vitap/"
              className="text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
      ...
      <div className="pt-5 pb-5 border-t text-center">
        <p className="text-md text-gray-300">
          Developed with 🤍 by{" "}
          <a
            href="https://www.linkedin.com/in/sai-pranay-53ab3b1aa/"
            className="link"
          >
            Sai Pranay
          </a>
